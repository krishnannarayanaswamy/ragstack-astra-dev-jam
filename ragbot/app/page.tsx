        ...
        <div className='chatbot-header pb-6'>
          <div className='flex justify-between'>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='chatbot-text-primary text-xl md:text-2xl font-medium'>FTB Bank AI Assistant</h1>
            </div>
