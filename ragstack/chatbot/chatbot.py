...
def create_chatbot(model="gpt-4"):
    ...
    retriever_tool = create_retriever_tool(
        retriever,
        "content_retriever",
        "Useful when searching for documents stored in vector store. \
         When calling this tool, include as much detail as possible, \
         and translate arguments to English.")

    system_message = f"""You are an ai assistant helping users answer any queries regarding he cassio.org open source project.
